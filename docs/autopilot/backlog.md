...
|---|---|---|---|---|---|---|---|---|
| B-001 | Create Autopilot Sprint Runner | Core OS | vysoky | nizke | autopilot-sprint-runner | dokumenty a sablony | LEVEL 1 | todo |
| B-002 | Create ESP32 ESPHome starter cluster | Produktovy cluster | vysoky | stredne | product-esp32-esphome-starter | cluster draft | LEVEL 2 | todo |
