...
| 2026-07-20 | STATUS RECONCILIATION: zaznamenat docs-only PR #48 a #49 a oznacit B-005 a B-006 ako dokoncene. | Register prelinkovania a rozsireny QA workflow odstranuju nejasnost medzi planovanymi vazbami, read-only kontrolou a lokalnym stagingom. | B-003, B-004 a B-007 az B-009 zostavaju planovane; W-012 nadalej caka na overene zalohy. | Technicka synchronizacia po uspesnej CI | zaznamenane |
