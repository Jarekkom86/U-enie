<footer class="footer">
  <div class="container">
    <div class="footer-grid">
      ...
      <div><h4>Obchod</h4><nav class="footer-links" aria-label="Obchod"><a href="<?php echo esc_url(home_url('/home-assistant/')); ?>">Home Assistant</a><a href="<?php echo esc_url(home_url('/esp-esphome/')); ?>">ESPHome</a><a href="<?php echo esc_url(home_url('/senzory/')); ?>">Senzory</a><a href="<?php echo esc_url(home_url('/napajanie/')); ?>">Napájanie</a><a href="<?php echo esc_url(home_url('/obchod/')); ?>">Všetky produkty</a></nav></div>
