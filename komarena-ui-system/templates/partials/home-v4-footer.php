<footer class="footer">
  <div class="container">
    <div class="footer-grid">
      ...
      <div><h4>Obchod</h4><nav class="footer-links" aria-label="Obchod"><a href="<?php echo esc_url(home_url('/kategoria/home-assistant/')); ?>">Home Assistant</a><a href="<?php echo esc_url(home_url('/kategoria/esphome/')); ?>">ESPHome</a><a href="<?php echo esc_url(home_url('/kategoria/senzory/')); ?>">Senzory</a><a href="<?php echo esc_url(home_url('/kategoria/napajanie/')); ?>">Napájanie</a><a href="<?php echo esc_url(home_url('/obchod/')); ?>">Všetky produkty</a></nav></div>
      <div><h4>Pomoc a servis</h4><nav class="footer-links" aria-label="Pomoc"><a href="<?php echo esc_url(home_url('/resmart/')); ?>">ReSmart servis</a><a href="<?php echo esc_url(home_url('/navody/')); ?>">Návody</a><a href="<?php echo esc_url(home_url('/kontakt/')); ?>">Kontakt</a><a href="<?php echo esc_url(home_url('/reklamacie/')); ?>">Reklamácie</a><a href="<?php echo esc_url(home_url('/doprava-a-platba/')); ?>">Doprava a platba</a></nav></div>
...
<div class="mobile-cta" aria-label="Rýchle akcie">
  <a class="btn btn-light" href="<?php echo esc_url(home_url('/obchod/')); ?>">Obchod</a>
